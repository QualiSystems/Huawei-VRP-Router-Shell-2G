...
# from cloudshell.networking.huawei.flows.huawei_connectivity_flow import (
#     HuaweiConnectivityFlow as ConnectivityFlow,
# )
from cloudshell.networking.huawei.flows.huawei_load_firmware_flow import (
    HuaweiLoadFirmwareFlow as FirmwareFlow,
)
...
class HuaweiVRPRouterShellDriver(
    ResourceDriverInterface, NetworkingResourceDriverInterface, GlobalLock
):
    SUPPORTED_OS = [r"VRP"]
    SHELL_NAME = "Huawei VRP Router 2G"

    def __init__(self):
        super(HuaweiVRPRouterShellDriver, self).__init__()
        self._cli = None
